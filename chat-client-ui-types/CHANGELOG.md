...
## [0.2.0](https://github.com/chungjac/language-server-runtimes/compare/chat-client-ui-types/v0.1.44...chat-client-ui-types/v0.2.0) (2025-06-14)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.38 to ^0.2.0
