...
## [0.2.0](https://github.com/chungjac/language-server-runtimes/compare/chat-client-ui-types/v0.1.66...chat-client-ui-types/v0.2.0) (2025-11-07)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.60 to ^0.2.0
