...
## [0.4.0](https://github.com/chungjac/language-server-runtimes/compare/language-server-runtimes/v0.3.9...language-server-runtimes/v0.4.0) (2025-11-26)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.63 to ^0.2.0
