...
## [0.4.0](https://github.com/chungjac/language-server-runtimes/compare/language-server-runtimes/v0.3.16...language-server-runtimes/v0.4.0) (2026-04-28)
...
* add save option to initializeResult to allow LSP server to listen to save file events ([#309](https://github.com/chungjac/language-server-runtimes/issues/309)) ([d80688f](https://github.com/chungjac/language-server-runtimes/commit/d80688fe272cedd352a9e5ed8cd13279cad392a7))
...
* adding support for alternate bearer token ([#715](https://github.com/chungjac/language-server-runtimes/issues/715)) ([2ae27f3](https://github.com/chungjac/language-server-runtimes/commit/2ae27f3ee6da4666fb1be6168bd14634705c3305))
...
* delegate lsp to handle context command filtering ([#743](https://github.com/chungjac/language-server-runtimes/issues/743)) ([8836c33](https://github.com/chungjac/language-server-runtimes/commit/8836c335180c13142b6789637cc5f3915e4a5475))
* delegate lsp to handle context command filtering ([#745](https://github.com/chungjac/language-server-runtimes/issues/745)) ([2c7174a](https://github.com/chungjac/language-server-runtimes/commit/2c7174a53ef792021c2d070867d87efe5ae2f7a8))
...
* **types:** types for device code support ([#353](https://github.com/chungjac/language-server-runtimes/issues/353)) ([aa2fd53](https://github.com/chungjac/language-server-runtimes/commit/aa2fd53ab14bbe412ede696e7eb86cd19a9b9b0b))
...
* atx bearer no longers update credential metadata ([#732](https://github.com/chungjac/language-server-runtimes/issues/732)) ([8b03630](https://github.com/chungjac/language-server-runtimes/commit/8b03630cce84bf145ac4cd7dadec88698c83bba5))
...
* bump node-forge to ^1.4.0 to resolve CVEs ([#746](https://github.com/chungjac/language-server-runtimes/issues/746)) ([c1cd1a4](https://github.com/chungjac/language-server-runtimes/commit/c1cd1a49775b188bd892540e11126b6dfe907dd3))
* CI builds failing due to proxyquire incompatibility with Node.js 24 ([#700](https://github.com/chungjac/language-server-runtimes/issues/700)) ([1e6bcab](https://github.com/chungjac/language-server-runtimes/commit/1e6bcabddf0634cea231fc7441511dab6c0431f7))
...
* cve ([#719](https://github.com/chungjac/language-server-runtimes/issues/719)) ([90597c2](https://github.com/chungjac/language-server-runtimes/commit/90597c209287640aeae34be4f5dbae35787c6e45))
...
* handling of aws object of initializationOptions and initialize error handling ([#306](https://github.com/chungjac/language-server-runtimes/issues/306)) ([f71547a](https://github.com/chungjac/language-server-runtimes/commit/f71547a7a27adb62231e2c096560988a09ff6fea))
...
* more logging for SSL certificates ([#727](https://github.com/chungjac/language-server-runtimes/issues/727)) ([98aaaa3](https://github.com/chungjac/language-server-runtimes/commit/98aaaa3f28ef134eb737292a11e2cbc25184db7b))
...
* override undici to ^7.0.0 ([#734](https://github.com/chungjac/language-server-runtimes/issues/734)) ([69d984f](https://github.com/chungjac/language-server-runtimes/commit/69d984f4c4134927f71b86cd2bfff088542ddba5))
...
* **runtimes:** replace mac-ca with native macOS certificate reading ([#736](https://github.com/chungjac/language-server-runtimes/issues/736)) ([134d721](https://github.com/chungjac/language-server-runtimes/commit/134d72158f73d2cd3614bf39fa24ad6ed9c9da0e))
* **runtimes:** replace registry-js with native reg query to remove vu… ([#737](https://github.com/chungjac/language-server-runtimes/issues/737)) ([a92164a](https://github.com/chungjac/language-server-runtimes/commit/a92164a65c105866aa6664af6420cf2443c9039c))
* **runtimes:** timeout for exiting to emit logs ([#602](https://github.com/chungjac/language-server-runtimes/issues/602)) ([0a062a3](https://github.com/chungjac/language-server-runtimes/commit/0a062a38854213ebe8ed388dc42c37ec65682473))
...
* updating atxCredentialProvider accessible in server ([#718](https://github.com/chungjac/language-server-runtimes/issues/718)) ([a0b50d4](https://github.com/chungjac/language-server-runtimes/commit/a0b50d40340a41724ab5cb14371bff869e7e234e))
...
* pr 719 as dependency change cause unexpected network issue on windows machine  ([#729](https://github.com/chungjac/language-server-runtimes/issues/729)) ([3987770](https://github.com/chungjac/language-server-runtimes/commit/3987770c5870d049cb5eb549dbe6a45175946798))
